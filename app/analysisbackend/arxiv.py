"""
forked from https://github.com/lukasschwab/arxiv.py with some modifications
"""
...
def query(search_query="", 
    ...
    url_args = re.sub('%2B','+',url_args) # to avoid the weird encoding url problem for arxiv API
    url = root_url + 'query?' + url_args
